...
export default function AutoVerkaufenHannoverPage() {
  return (
    <div>
      {/* Hero */}
      <section className="relative text-white py-16 lg:py-24 overflow-hidden"><div className="absolute inset-0"><img src="/images/hero-autohaus-desktop.webp" alt="Auto verkaufen in Hannover — Mizo Autohaus Fahrzeuge" className="w-full h-full object-cover object-bottom" loading="eager" /><div className="absolute inset-0 bg-primary/85" /></div>
