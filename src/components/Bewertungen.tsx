...
const bewertungen = [
  { name: 'Imad', zeit: 'vor 2 Jahren', sterne: 5, text: 'Der Verkaufsberater war sehr freundlich und kompetent. Er hat sich Zeit genommen, um meine Bedürfnisse zu verstehen. Ich kann das Autohaus jedem empfehlen!' },
  { name: 'Jumbo G.', zeit: 'vor 2 Jahren', sterne: 5, text: 'Was man hier positiv festhalten muss sind die Preise. Bezahlbar und fair für beide Parteien. Habe den Laden vielen Freunden empfohlen.' },
  { name: 'Monika K.', zeit: 'vor einem Jahr', sterne: 5, text: 'Beste Menschen in Hannover, immer hilfsbereit, finden für alles eine Lösung und haben mir richtig gut und unproblematisch geholfen.' },
  { name: 'Mustafa C.', zeit: 'vor 2 Jahren', sterne: 5, text: 'Sehr netter Verkäufer, und hat sich stets an sein Wort gehalten was den TÜV und die Anmeldung betrifft. Weiter zu empfehlen, top!' },
  { name: 'Nader S.', zeit: 'vor 2 Jahren', sterne: 5, text: 'Top Preise, top Service. Sehr hilfsbereit, freundlich und ehrlich.' },
  { name: 'Atelva Media GmbH', zeit: 'vor 2 Jahren', sterne: 5, text: 'Wir sind mega zufrieden und können das Autohaus vorbehaltlos empfehlen. Preis/Leistungsverhältnis stimmt hier einfach.' },
  { name: 'Mohamed A.', zeit: 'vor 11 Monaten', sterne: 5, text: 'Top Beratung, top Preis-Leistungs-Verhältnis.' },
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5 sm:gap-6 mb-8 sm:mb-14">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 bg-white/[0.06] border border-white/[0.1] rounded-xl px-3.5 sm:px-4 py-2.5 sm:py-3">
