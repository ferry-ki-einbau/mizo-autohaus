      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 lg:gap-8 mb-16 sm:mb-20 lg:mb-28">
          {stats.map((stat, index) => (
            <div
              key={stat.label}
              className={`reveal reveal-d${index + 1} text-center p-4 sm:p-6 lg:p-10 rounded-2xl lg:rounded-3xl bg-bg-soft border border-border hover:border-accent/20 transition-all duration-300 group`}
            >
